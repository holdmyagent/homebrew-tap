class HmaWarden < Formula
  include Language::Python::Virtualenv

  desc "Enforcement daemon for Hold My Agent approvals"
  homepage "https://holdmyagent.com"
  url "https://files.pythonhosted.org/packages/e5/c9/148ad62924c89369a803e211e11e248c2180858a73c11e7c406fdaf8bd72/hold_warden-0.1.0.tar.gz"
  sha256 "6dc9a5e195cc30b8f2c13de7522a1c6149db47c2ebd6654701f14f4e41794d73"
  license "MIT"
  ...
  test do
    assert_match "trusted component that executes approved actions",
                 shell_output("#{bin}/hma-warden --help")
  end
end
